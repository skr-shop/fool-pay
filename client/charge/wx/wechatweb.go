...
type WxPubCharge struct {
	...
	common.PubChargeClient
}

func NewWxPubCharge(config common.BaseConfig) WxPubCharge {
	wx := WxPubCharge{
		ConfigWxData: config.ConfigWxData,
	}
	wx.This = wx
	return wx
}

func (wpc WxPubCharge) SetSign() interface{} {
	return "签名?!没有"
}

func (wpc WxPubCharge) Send() interface{} {
	fmt.Println(wpc.PubChargeClient.Send())
	return wpc.ConfigWxData
}
...
// 	"github.com/lxp521125/fool-pay/util"
// 	"sort"
// 	"strings"
// 	"time"
// )
